...
- 2026-03-11: **Isporuka – totalCards pri kreiranju i importu.** Pri kreiranju isporuke polje "Ukupno kartica" nije obavezno i nije prikazano u formi; backend prihvata totalCards kao opcionalno (default 0). Pri Excel importu u isporuku broj uvezenih SIM kartica automatski se upisuje u totalCards isporuke (postojeća logika u importExcel).
