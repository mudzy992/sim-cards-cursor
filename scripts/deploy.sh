...
vm_menu() {
  ...
  echo "  2) Backend (app kod, offline build NA VM-u, koristi postojeći deps image. Kopira se na VM fajl sa izmjenjenim kodom i builduje se tamo sa ovom opcijom)"
  echo "  3) Frontend — build dist-a (NA MAŠINI SA INTERNETOM - kada su izmjene na kodu frontenda buildamo na mašini sa internetom i pratimo korake)"
